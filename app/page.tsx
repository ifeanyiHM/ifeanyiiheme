  ...
  return (
    <>
      ...
      <header className="flex flex-col">
        <div className="flex-grow flex flex-col justify-between sm:my-[5rem] xl:mt-[2rem] xl:mb-[0] pl-[2.125rem] pr-[3.125rem] sm:px-[6.25rem] py-[4.375rem] sm:py-[7.5rem] xl:pt-[4rem] xl:pb-0">

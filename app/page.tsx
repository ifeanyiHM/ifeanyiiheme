  ...
  return (
    <>
      ...
      <header className="flex flex-col h-[100svh] xl:h-full ">
        <div className="flex-grow flex flex-col justify-between sm:my-[5rem] xl:mt-[2rem] xl:mb-[0] pl-[2.125rem] pr-[3.125rem] sm:px-[6.25rem] pt-[3.375rem] sm:pt-[5.5rem] xl:pt-[5.2rem] xl:pb-0">
